...
description: >-
  ...
  motion, and copy that avoid templated AI defaults. Use when designing or
  restyling pages, landing surfaces, marketing UI, dashboards with a visual
  brief, component look-and-feel, or when the user asks for frontend design,
  visual polish, or a non-generic UI.
---
