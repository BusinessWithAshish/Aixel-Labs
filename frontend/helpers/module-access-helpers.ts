 ...
 */
export function toggleAllSubModules(
  moduleAccess: ModuleAccess,
  module: Modules,
  enabled: boolean
): ModuleAccess {
 ...
 */
export function areAllSubModulesEnabled(
  moduleAccess: ModuleAccess | undefined,
  module: Modules
): boolean {
  if (!moduleAccess) return false;
  ...
  return (
    currentSubModules.length === allSubModules.length &&
    allSubModules.every((sm) => currentSubModules.includes(sm))
  );
}
 ...
 */
export function areSomeSubModulesEnabled(
  moduleAccess: ModuleAccess | undefined,
  module: Modules
): boolean {
  if (!moduleAccess) return false;
  ...
  return (
    ...
    currentSubModules.length < getSubModulesForModule(module).length
  );
}
