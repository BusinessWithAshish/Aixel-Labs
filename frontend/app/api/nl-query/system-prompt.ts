export const enum NLQuerySystemPromptPlaceholders {
    SCHEMA_DESCRIPTION = 'SCHEMA_DESCRIPTION',
    SAMPLE_DATA = 'SAMPLE_DATA',
    USER_QUERY = 'USER_QUERY',
}

export const NLQuerySystemPrompt = `You are an intelligent data query assistant that translates natural language into JavaScript array transformations.
...
${NLQuerySystemPromptPlaceholders.SAMPLE_DATA}
