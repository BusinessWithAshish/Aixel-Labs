...
import { registerYoutubeVideoCommentsRoutes } from "./comments";
import { registerYoutubeVideoDownloadRoutes } from "./download";
...
registerYoutubeVideoCommentsRoutes(youtubeRoutes);
