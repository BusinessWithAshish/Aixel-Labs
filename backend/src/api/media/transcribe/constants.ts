...
export const MEDIA_TRANSCRIBE_FIELD_DESCRIPTIONS = {
  mediaSource:
...
export const MEDIA_TRANSCRIBE_FORMAT = {
  TXT: "txt",
  JSON: "json",
  SRT: "srt",
  VTT: "vtt",
...
export const MEDIA_TRANSCRIBE_MODEL = {
  TURBO: "whisper-large-v3-turbo",
  LARGE: "whisper-large-v3",
} as const;

export const MEDIA_TRANSCRIBE = {
  DEFAULT_FORMAT: MEDIA_TRANSCRIBE_FORMAT.TXT,
  DEFAULT_MODEL: MEDIA_TRANSCRIBE_MODEL.TURBO,
...
/**
 * Source resolution (local path / URL, TLS-fingerprint fallback,
 * Vercel guard) is shared — see `../source.ts` and its own
 * `MEDIA_ERROR_MESSAGES`/`MEDIA_GATED_STATUS_CODES`. This file only owns
 * transcribe's own errors, from the point it already has a local file.
 */
export const MEDIA_TRANSCRIBE_ERROR_MESSAGES = {
