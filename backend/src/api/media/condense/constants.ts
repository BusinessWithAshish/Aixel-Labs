...
/**
 * Condense — single source of truth for silence-detection thresholds, the
...
export const MEDIA_CONDENSE_FIELD_DESCRIPTIONS = {
  videoSource:
  ...
  minSilenceSeconds:
    "A silent stretch must last at least this long to be considered removable at all. Below ~0.3 you start cutting the natural micro-pauses between words, which is what makes over-condensed audio sound machine-gunned.",
  keepPaddingSeconds:
 ...
 */
export const MEDIA_CONDENSE_VERBATIM_PROMPT =
 ...
 */
export const MEDIA_CONDENSE_DEFAULT_FILLER_WORDS = [
  "uh",
  "um",
  "er",
  "erm",
...
export const MEDIA_CONDENSE = {
  ...
  /**
   * ffmpeg encode settings. Condense always re-encodes: `select` + `setpts`
  ...
  MEDIA_TRANSCRIBE_MODEL: "whisper-large-v3-turbo",
} as const;

export const MEDIA_CONDENSE_ERROR_MESSAGES = {
  ...
  OUTPUT_WRITE_FAILED: "Failed to write the condensed video to disk",
  GENERIC: "Condense failed",
  VERCEL:
